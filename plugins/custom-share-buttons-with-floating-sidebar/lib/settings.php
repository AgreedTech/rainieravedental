...
<!-- Start Options Form -->
   ...
   <td valign="top" style="border-left:1px solid #ccc;padding-left:20px;">
	  ...
	  <div class="offer-announcement"><h2><i class="csbwfs dashicons-before dashicons-megaphone"></i><a href="https://www.wp-experts.in/products/share-buttons-with-floating-sidebar-pro-addon">FLAT 50% DISCOUNT ON PLUGIN ADD-ON</a></h2><em class="tagline">No Coupon Code Required. Hurry! Limited Time Offer!</em></div>
<hr>
<h3>Add-on Features</h3>
<ul class="hand right-click twocolumn">
...
<li>10 extra custom sidebar buttons</li>
...
<!-- GO PRO -->
	...
	<iframe width="100%" height="350" src="https://www.youtube.com/embed/L8UAqBbqqoU?rel=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
	</td>
